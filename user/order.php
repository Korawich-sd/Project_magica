        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="order-address-box">
                ...
                <div class="order-box-input-address">
                    ...
                    <a href="../user/profile_address.php"><button type="button" class="order-btn-address-submit">เปลี่ยน</button></a>
                    ...
                    <table class="table table-hover table-order-style">
                        ...
                        for ($i = 0; $i < count($product); $i++) {  ?>
                            ...
                            <tbody class="align-middle">
                                <tr>
                                    <th>
                                        <img class="img-list-order" src="../asset/upload/product/<?= $final_p[$i][0][6] ?>" alt="">
                                    </th>
