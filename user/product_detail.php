        ...
        if (!empty($rowCheck)) {
            foreach ($rowCheck as $rowCheck) {
                if ($rowCheck['product_id'] == $p_id) {
                    ...
                    // })
                    // </script>";
                    header("refresh:0.00001; url=cart.php");
                    if ($check_state == true) {
                        break;
                    }
                } else {
            ...
            if ($check_state == false) {
                ...
                if ($sql) {
                    ...
                    // </script>";
                    $check_state = true;
                    header("refresh:0.0000001; url=cart.php");
                } else {
                    ...
                    <div class="related-RT">
                        <div class="card" id="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="../user/product_detail.php?p_id=<?= $rowRT['p_id']; ?>" class="btn " id="btn-dp" style="margin: 0 auto;">รายละเอียด</a>
                            </div>
                        </div>
                    </div>
                <?php
