...
if (isset($_POST['submit'])) {
    ...
    if (empty($addressed)) {
        ...
        header("refresh:0.0000000000001; url=profile_address.php");
    } else if (empty($provinces)) {
        echo "<script>alert('กรุณากรอกข้อมูลให้ครบถ้วน')</script>";
        header("refresh:0.0000000000001; url=profile_address.php");
    } else if (empty($amphures)) {
        echo "<script>alert('กรุณากรอกข้อมูลให้ครบถ้วน')</script>";
        header("refresh:0.0000000001; url=profile_address.php");
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="profile_address_form.php" method="POST">
                    <div class="box-1">
