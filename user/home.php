...
<body style="font-family: 'Kanit', sans-serif ;">
                    ...
                    <div class="btnn-profile">
                        ...
                        <div class="profile-icon">
                            <div class="dropdown"><button type="button" id="icon-profile" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="../asset/upload/profile_user/<?php if ($row['m_img'] == null) {echo "icon-profile.png";
                                    } else {
                                        echo $row['m_img'];
                                    }
    ...
    <div class="user-catagorie">
        <div class=" item-catagorie">
            ...
            <div class="user-cat-box">
                <div class="bg-item">
                    <div class="item">
                        <a href="../user/product.php?t_id=2&name=อาหารเสริม" style="text-decoration: none;">
                ...
                <div class="bg-item">
                    <div class="item">
                        <a href="../user/product.php?t_id=1&name=ยาสามัญประจำบ้าน" style="text-decoration: none;">
    ...
    <div class="recommence-product">
        ...
        <div class="box-rec-pd">
            ...
            ?>
                    <div class="rec-pd">
                        <a class="a-none" href="../user/product_detail.php?p_id=<?= $product['p_id']; ?>">
                            <div class="card" id="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="../user/product_detail.php?p_id=<?= $product['p_id']; ?>" class="btn " id="btn-dp" style="margin: 0 auto;">รายละเอียด</a>
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            <div class="btn-see-more">
                <a href="../user/product.php"><button type="button" class="btn" id="see-more">ดูเพิ่มเติม</button></a>
            </div>
