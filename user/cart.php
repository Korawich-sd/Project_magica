...
if (isset($_POST['submit_order'])) {
    if (count((array)$_POST['ids']) > 0) {
        ...
        if ($stmt) {
            ...
            header("refresh:0.0000000001; url=order.php?product=$product&qty=$aaa");
        } else {
            //   echo "<script>alert('มีบางอย่างผิดพลาด');</script>";
            header("refresh:0.0000000001; url=cart.php");
        }
    } else {
...
<body style="font-family: 'Kanit', sans-serif ;">
    ...
    <div class="bg-box-cart">
        ...
        <div class="box-cart">
            ...
            <form action="../user/cart.php" class="box-bg-cart" method="post">
