            ...
            if ($slip_img['size'] > 0 && $slip_img['error'] == 0) {
                if (move_uploaded_file($slip_img['tmp_name'], $filePath1)) {
                    ...
                    if ($order) {
                        ...
                        header("location: dealer_gen_cart.php");
                    }
                }
            }
        }
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="order-address-box">
                ...
                <div class="order-box-input-address">
                    ...
                    <a href="../dealer_general/dealer_gen_profile_address.php"><button type="button" class="order-btn-address-submit">เปลี่ยน</button></a>
