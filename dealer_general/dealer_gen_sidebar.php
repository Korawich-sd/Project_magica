        ...
        <div class="p-bg-menu" style="padding-left: 0px; padding-right: 0px;">
            <div class="p-sub-bg-menu">
                ...
                <ul class="list-unstyled ps-0">
                    <li class="mb-1">
                        ...
                        <div class="collapse show" id="home-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small sidebar-flip">
                                <li><a href="../dealer_general/dealer_gen_profile.php" id="p-list-menu">
                                        <p id="p-list-menu">ข้อมูลของฉัน</p>
                                    </a></li>
                                <li ><a href="../dealer_general/dealer_gen_profile_bank.php" id="p-list-menu"> 
                                        <p id="p-list-menu">บัญชีธนาคาร</p>
                                    </a></li>
                                <li ><a href="../dealer_general/dealer_gen_profile_password.php" id="p-list-menu">
                                        <p id="p-list-menu">เปลี่ยนรหัสผ่าน</p>
                                    </a></li>
                                <li ><a href="../dealer_general/dealer_gen_profile_address.php" id="p-list-menu">
                    ...
                    <li class="mb-1">
                       <a href="../dealer_general/dealer_gen_my_purchase.php"><button class="btn btn-toggle" id="p-btn-color" data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="false">
                            การซื้อของฉัน
                        </button></a>
