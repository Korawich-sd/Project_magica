        ...
        <div class="cata-med">
            <div class="bg-cat-med">
                ...
                <?php foreach ($p_type as $p_type) { ?>
                    <a href="../dealer_general/dealer_gen_product.php?t_id=<?= $p_type['t_id']; ?>&name=<?= $p_type['t_name'] ?>" style="text-decoration: none; width: 90%; color: #000000;">
        ...
        <div class="pd">
            ...
            foreach ($result as $result) { ?>
                <div class="content-pd">
                    <a class="a-none" href="../dealer_general/dealer_gen_product_detail.php?p_id=<?= $result['p_id']; ?>">
                        <div class="card" id="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="../dealer_general/dealer_gen_product_detail.php?p_id=<?= $result['p_id']; ?>" class="btn " id="btn-dp" style="margin: 0 auto;">รายละเอียด</a>
                            </div>
                        </div>
                    </a>
                </div>
