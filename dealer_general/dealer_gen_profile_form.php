...
if (isset($_POST['update'])) {
    ...
    $sql = $conn->prepare("UPDATE dealer_general SET firstname = :firstname, lastname = :lastname, email = :email, tel = :tel, line_Id = :line_Id WHERE id = :id");
    $sql->bindParam(":id", $id);
    ...
    if($sql){
        ...
        header("refresh:0.0000000001; url=dealer_gen_profile.php");
    }
}
