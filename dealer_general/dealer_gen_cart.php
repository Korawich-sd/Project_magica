...
if (isset($_POST['submit_order'])) {
    if (count((array)$_POST['ids']) > 0) {
        ...
        if ($stmt) {
            ...
            header("refresh:0.0000000001; url=dealer_gen_order.php?product=$product&qty=$aaa");
        } else {
...
if (isset($_POST['delete'])) {
    if (count((array)$_POST['ids']) > 0) {
        ...
        if ($sql) {
            ...
            header("refresh:2; url=dealer_gen_cart.php");
        } else {
            echo "<script>alert('มีบางอย่างผิดพลาด');</script>";
            header("refresh:0.0000000001; url=dealer_gen_cart.php");
        }
...
<body style="font-family: 'Kanit', sans-serif ;">
    ...
    <div class="bg-box-cart">
        ...
        <div class="box-cart">
            ...
            <form action="../dealer_general/dealer_gen_cart.php" class="box-bg-cart" method="post">
