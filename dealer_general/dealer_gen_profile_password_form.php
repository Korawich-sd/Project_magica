...
if (isset($_POST['submit_password'])) {
    ...
    if (empty($old_password)) {
        ...
        header("location: dealer_gen_profile_password.php");
            ...
            if (!isset($_SESSION['error_pass'])) {
                if (password_verify($old_password, $row['password'])) {
                    ...
                    if ($sql) {
                        ...
                        header("refresh:0.0000000001; url=dealer_gen_profile_password.php");
                    }
                } else {
...
<div class="p-form-box">
    ...
    <div class="content">
        <form action="dealer_gen_profile_password_form.php" method="post">
