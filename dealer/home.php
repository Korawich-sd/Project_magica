    ...
    <div class=" catagorie">
        <div class="item-catagorie">
            ...
            <div class="dealer-cat-box">
                <div class="bg-item">
                    <div class="item">
                        <a href="../dealer/dealer_product.php?t_id=2&name=อาหารเสริม" style="text-decoration: none;">
                ...
                <div class="bg-item">
                    <div class="item"><a href="../dealer/dealer_product.php?t_id=3&name=ยาจ่ายผ่านคลินิก" style="text-decoration: none;">
                ...
                <div class="bg-item">
                    <div class="item"><a href="../dealer/dealer_product.php?t_id=4&name=ยาที่ขึ้นทะเบียนแล้ว" style="text-decoration: none;">
                            <!-- <div class="item-bord"><img class="icon-med-hidden" src="/magica/asset/img/med-icon2.png" alt="med2"></div> -->
                ...
                <div class="bg-item">
                    <div class="item"><a href="../dealer/dealer_product.php?t_id=5&name=ยาแผนโบราณ" style="text-decoration: none;">
                            <!-- <div class="item-bord"><img class="icon-med-hidden" src="/magica/asset/img/med-icon2.png" alt="med2"></div> -->
                ...
                <div class="bg-item">
                    <div class="item"><a href="../dealer/dealer_product.php?t_id=1&name=ยาสามัญประจำบ้าน" style="text-decoration: none;">
                            <!-- <div class="item-bord"><img class="icon-med-hidden" src="/magica/asset/img/med-icon2.png" alt="med2"></div> -->
